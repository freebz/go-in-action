...
// Add attaches task to the Runner. A task is a function that
// takes an int ID.
...
func (r *Runner) Start() error {
    ...
    // Run the defferent tasks on a defferent goroutine.
    go func() {
        r.complete <- r.run()
    }()
...
// run executes each registerd task.
...
func (r *Runner) gotInterrupt() bool {
    ...
    case <-r.interrupt:
        // Stop reeiving any further signals.
